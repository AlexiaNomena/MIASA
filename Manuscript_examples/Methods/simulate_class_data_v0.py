    ...
    for i in range(5):
        ...
        for j in range(MaxNumVar + 1):
            ...
            if j < num_var[lab[2]]:
                ...
                class_dic[class_type3[i]+"%d_%d"%(j+1, 0)] = lab[2] 
                ...
                class_dic[class_type3[i]+"%d_%d"%(j+1, 1)] = lab[2] 
            ...
            if j <= num_var[lab[3]]:
                ...
                class_dic[class_type4[i]+"%d_%d"%(j+1, 0)] = lab[3] 
                ...
                class_dic[class_type4[i]+"%d_%d"%(j+1, 1)] = lab[3] 
